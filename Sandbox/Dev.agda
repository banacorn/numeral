...
subsume-contra {b} {d} {o} (x ∙) d+o≥2 ¬gapped with Others-view-single b d o x
subsume-contra {b} {d} {o} (x ∙) d+o≥2 ¬gapped | NeedNoCarry ¬greatest =
    start
        Digit-toℕ (digit+1 x ¬greatest) o ∸ Digit-toℕ x o
    ≈⟨ cong (λ w → w ∸ Digit-toℕ x o) (next-number-Others-NeedNoCarry-Single {b} x ¬greatest) ⟩
        suc (Fin.toℕ x + o) ∸ (Fin.toℕ x + o)
    ...
    ≤⟨ m≤m⊔n 1 o ⟩
        suc zero ⊔ o
    □
subsume-contra {b} {d} {o} (x ∙) d+o≥2 ¬gapped | Gapped greatest gapped
    = contradiction gapped (>⇒≰ ¬gapped)
subsume-contra {b} {d} {o} (x ∙) d+o≥2 _ | ¬Gapped greatest ¬gapped =
    start
        ⟦ digit+1-n x greatest ((1 ⊔ o) * suc b) lower-bound ∷ 1⊔o d o d+o≥2 ∙ ⟧ ∸ Digit-toℕ x o
    ≈⟨ cong (λ w → w ∸ Digit-toℕ x o) (next-number-suc-Others-¬Gapped-Single x greatest d+o≥2 ¬gapped) ⟩
        suc (Fin.toℕ x + o) ∸ (Fin.toℕ x + o)
    ...
    where
        lower-bound : (1 ⊔ o) * suc b > 0
        lower-bound = m≤m⊔n 1 o *-mono s≤s z≤n
subsume-contra {b} {d} {o} (x ∷ xs) d+o≥2 ¬gapped with Others-view x xs (next-number-¬Maximum (x ∷ xs) d+o≥2) d+o≥2
subsume-contra {b} {d} {o} (x ∷ xs) d+o≥2 ¬gapped | NeedNoCarry ¬greatest =
    start
        ⟦ digit+1 x ¬greatest ∷ xs ⟧ ∸ ⟦ x ∷ xs ⟧
    ≈⟨ cong (λ w → w ∸ ⟦ x ∷ xs ⟧) (next-number-Others-NeedNoCarry x xs ¬greatest) ⟩
        suc ⟦ x ∷ xs ⟧ ∸ ⟦ x ∷ xs ⟧
    ...
    ≤⟨ m≤m⊔n 1 o ⟩
        suc zero ⊔ o
    □
subsume-contra {b} {d} {o} (x ∷ xs) d+o≥2 ¬gapped | Gapped greatest gapped
    ...
    where
        ...
        p =
            ...
            ≤⟨ *n-mono (suc b) (subsume-contra xs d+o≥2 ¬gapped) ⟩
                (suc zero ⊔ o) * suc b
            □
subsume-contra {b} {d} {o} (x ∷ xs) d+o≥2 ¬gapped₁ | ¬Gapped greatest ¬gapped =
    start
...
--     ≤⟨ gapped ⟩
--         (⟦ next-number-Others xs (next-number-¬Maximum xs d+o≥2) d+o≥2 ⟧ ∸ ⟦ xs ⟧) * suc b
--     ≤⟨ *n-mono (suc b) (subsume-contra xs d+o≥2 {!   !}) ⟩
--         (suc zero ⊔ o) * suc b
--     □
-- start
--     {!   !}
