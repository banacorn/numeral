...
The previous paragraphs are mostly addressing the \textit{programming}
aspect of this language. But Agda is more than that! Recall the Curry–Howard
correspondence, writing

% So far we are mostly the programming aspect of this langauge.
...
% Numerals in positional numeral systems are composed of sequences of symbols
