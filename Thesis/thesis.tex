...
To make things clear, we call a sequence of digits a \textbf{notation}, and
the number it expresses a \textbf{value}, or simply a \textbf{number}. That is,
...
Such a numeral system is said to be redundant. In fact, systems that allow $ 0 $
as one of the digits must be redundant, since we can always take a number and
add leading zeros without changing it's value.


Data structures modeled after
redundant numeral systems have some interesting properties. Self-balancing containers


% They show interesting properties
