...
\begin{figure}[H]
    ...
    \begin{adjustbox}{max width=\textwidth}
        ...
        \end{tikzpicture}
    \end{adjustbox}
\caption{Range of digit assignments}
\label{figure:8}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \path[-stealth]
            ...
            ;
    \end{tikzpicture}
\caption{Converting between \lstinline|ℕ| and \lstinline|Digit d|}
\label{figure:9}
\end{figure}
    ...
    \begin{tikzpicture}
      ...
      \path[-stealth]
            ...
            (m-1-2)
                ...
                % edge [dashed,-] (m-2-1);
    \end{tikzpicture}
\caption{\lstinline|Digit-toℕ| preserves the successor function}
\label{figure:10}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{tikzpicture}
\caption{\lstinline|Digit-toℕ| preserves \lstinline|+ 1 ∸ n|}
\label{figure:11}
\end{figure}
