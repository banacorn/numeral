...
\footnote{As a reminder, the order of digits \scm{of non-decimal numerals} are reversed.}
...
These containers are preferable to their \scmsubst{"zeroful"}{``zeroful''} counterparts.
...
\scm{The ``Because'' is dangling. Say something like ``The reason is that...''}
...
them in \scmsubst{the chapter}{Chapter}~\ref{constructions}.
