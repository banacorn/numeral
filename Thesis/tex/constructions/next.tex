...
Paul Benacerraf once argued\cite{benacerraf1965numbers} \scmsubst{that, }{that}
...
\scmsubst{And it}{It} seems that one can only learn how to count intransitively first,
