...
However, if we allow \lstinline|fromℕ| to convert only the natural numbers
that is greater than $o$ instead of $0$, making it a partial function,
...
\lstinline|Continuous| will be useful; we did not work our head off constructing
