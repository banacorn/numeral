...
of \lstinline|⟦_⟧|.
% However, we would be held back by \textit{redundant} systems and fail miserably
% because \lstinline|⟦_⟧| is not injective.

% Systems such as the ordinary decimal numerals are redundant because there are
% more than one way to represent a number.
