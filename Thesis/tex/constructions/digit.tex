...
which can be indexed to have \scmsubst{some}{an} exact number of inhabitants.
...
\scmsubst{would have}{has} exactly \textit{n} inhabitants.
...
\scm{Change \lstinline|Fin| to \lstinline|Digit| in the type of \lstinline|digit+1|?}
