...
\tikzset{knoten/.style={draw, circle, thick}}
\tikzset{pfeil/.style={draw, -latex}}

\begin{center}
    \begin{tikzpicture}
        \node[knoten]{$10$}
            child[grow=right] {node[knoten]{$20$} 
                child[grow=right] {node[knoten]{$30$}
                    child[grow=right] {node[knoten]{$40$}}}};
    \end{tikzpicture}
\end{center}
