...
\chapter{Introduction [still writing]}\label{introduction}
...
of other bases. We will resolve this inconsistency by generalizing digit assignments
in the next chapter.
...
known. In the next chapter, we will show that these special characteristics can
