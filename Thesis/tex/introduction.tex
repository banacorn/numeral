...
attached to the path that we call \textit{``spine''}.
...
There are also other kinds of building blocks, such as complete leaf trees.
...
A numerical representation is composed of a series of building blocks
of different ranks and are ordered accordingly.
...
% binary leaf trees as building blocks.
%
...
% the tallest perfect binary tree takes at most $ O(lglg n) $ to traverse.
%
...
% This is caused by
% Consider a random access list with $ 8 $ elements, it would take
...
%
% We need a more versatile numeral system to accommodate these numerical representations.
