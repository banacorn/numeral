...
representations. Instead, we need a more versatile representation for numeral systems.

\section{Outline}
The remainder of the thesis is organized as follows.
Chapter~\ref{generalization} proposes some generalizations to accommodate the
