...
Continuous-Proper-Gapped-counter-example : ∀ {b d o}
    → (proper : 2 ≤ suc (d + o))
    → (gapped : Gapped {b} (greatest-digit d ∙) proper)
...
Continuous-Proper-Gapped {b} {d} {o} proper gapped cont
...
Continuous-Proper-¬Gapped : ∀ {b d o}
    ...
    → Continuous (suc b) (suc d) o
Continuous-Proper-¬Gapped proper ¬gapped xs with nextView xs proper
Continuous-Proper-¬Gapped proper ¬gapped xs | NeedNoCarry b d o ¬greatest
    = (next-number-Proper xs proper) , (begin
        ...
        ≡⟨ next-number-Proper-NeedNoCarry-lemma xs ¬greatest proper ⟩
            suc ⟦ xs ⟧
        ∎)
Continuous-Proper-¬Gapped proper ¬gapped (x ∙)    | IsGapped b d o greatest gapped = contradiction gapped ¬gapped
Continuous-Proper-¬Gapped proper ¬gapped (x ∷ xs) | IsGapped b d o greatest gapped
    = contradiction gapped (¬Gapped#0⇒¬Gapped#N xs proper ¬gapped)
Continuous-Proper-¬Gapped proper _ xs | NotGapped b d o greatest ¬gapped
    = (next-number-Proper xs proper) , (begin
        ⟦ next-number-Proper xs proper ⟧
...
Continuous-Proper b d o proper | yes gapped#0 = no  (Continuous-Proper-Gapped proper gapped#0)
Continuous-Proper b d o proper | no ¬gapped#0 = yes (Continuous-Proper-¬Gapped proper ¬gapped#0)
